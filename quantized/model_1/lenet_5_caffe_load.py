...
from sparseconnect import sparseconnect_layer, sparseconnect_CNN_layer, sparseconnect_CNN_layer_filter, sparseconnect_CNN_layer_filter_tile_2, sparseconnect_CNN_layer_filter_tile_4,  sparseconnect_layer_tile_2, sparseconnect_layer_tile_4
...
model = tf.keras.models.load_model('weights.76-0.9942.hdf5',  custom_objects={'sparseconnect_CNN_layer_filter_tile_2':sparseconnect_CNN_layer_filter_tile_2,'sparseconnect_layer_tile_2':sparseconnect_layer_tile_2, 'sparseconnect_CNN_layer':sparseconnect_CNN_layer})
