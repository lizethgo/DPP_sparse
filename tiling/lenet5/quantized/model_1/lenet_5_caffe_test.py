...
n_connect_CNN_1 = 15 # number of active inputs per element of kernel
...
x_4 = sparseconnect_layer(units=500,n_connect=49,activation='relu',n_epochs=n_epochs, tempIncr=5)(x_3)
