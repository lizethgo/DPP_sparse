...
class DPS_topk(Layer):
    ...
    def call(self, inp):
        ...
        if self.is_CNN == True:
            ...
            ### Forwards ###
            GN = -0.0*tf.math.log(-tf.math.log(tf.random.uniform((self.BS,data_shape[0], data_shape[1], data_shape[2]),0,1)+1e-20)+1e-20) #[BS,output_nodes,input_nodes]
            ...
            logits = inp  #[output_nodes,input_nodes]
            ### Forwards ###
            GN = -0.*tf.math.log(-tf.math.log(tf.random.uniform((self.BS,data_shape[0], data_shape[1]),0,1)+1e-20)+1e-20) #[BS,output_nodes,input_nodes]
