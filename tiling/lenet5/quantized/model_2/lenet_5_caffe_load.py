...
from sparseconnect import sparseconnect_layer, sparseconnect_CNN_layer, sparseconnect_CNN_layer_filter, sparseconnect_CNN_layer_filter_tile_2, sparseconnect_CNN_layer_filter_tile_4,  sparseconnect_layer_tile_2,  sparseconnect_layer_tile_5, sparseconnect_CNN_layer_filter_tile_4
...
model = tf.keras.models.load_model('weights.57-0.9940.hdf5',  custom_objects={'sparseconnect_CNN_layer_filter_tile_4':sparseconnect_CNN_layer_filter_tile_4,'sparseconnect_layer_tile_5':sparseconnect_layer_tile_5, 'sparseconnect_CNN_layer':sparseconnect_CNN_layer})
