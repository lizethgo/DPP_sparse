...
# x_2 = sparseconnect_CNN_layer(
                              ...
                              # n_epochs=n_epochs, 
                              # tempIncr=5)(x_1)
x = sparseconnect_CNN_layer_filter_tile_2(n_connect_ch =3, 
                              filters = 50, 
                              kernel_size = 5, 
                              channel_size = 20, 
                              activation='relu',
...
x_4 = sparseconnect_layer_tile_2(units=500,n_connect=25,activation='relu',n_epochs=n_epochs, tempIncr=5)(x_3)
